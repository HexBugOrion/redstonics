...
public class RedstonicDrillTool extends MiningToolItem {

    private static Set<Block> EFFECTIVE_BLOCKS;
    protected RedstonicDrillTool(float attackDamage, float attackSpeed, ToolMaterial material, Set<Block> effectiveBlocks, Item.Settings settings) {
